...
ActiveRecord::Schema.define(:version => 20130830104227) do

  create_table "refinery_footer_slides", :force => true do |t|
    t.string   "title"
    t.text     "description"
    t.integer  "position"
  ...
  create_table "refinery_media_files", :force => true do |t|
    t.string   "title"
    t.text     "description"
    t.string   "video_url"
