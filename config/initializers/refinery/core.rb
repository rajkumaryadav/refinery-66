...
Refinery::Core.configure do |config|
  ...
  config.s3_access_key_id = 'AKIAIKA7UG4DT4DQD3XA'
  config.s3_secret_access_key = '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'
  config.s3_bucket_name = 'metropartners'
  ...
  # config.dragonfly_secret = "f5b9bf53ad95bbaf9b0d781af3c73e32964fdba4514754a8"
